...
\email{\{benjamin,thomas\}}.bosch@gesis.org}
...
\tb{we could provide full day if we make the hands on exercises with the SPARQL queries / do you think we should do that?}
