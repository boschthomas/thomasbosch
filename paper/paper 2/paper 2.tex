...
\ms{Complex constraints} encompass complex constraints and \ms{simple constraints} (atomic constraints).
...
\textbf{Context-Specific Exclusive OR of Property Groups.}
\begin{gcotable}
class & Half-Klingon & - & - & E, F & XOR \\
class & E & - & - & A, B & $\sqcap$ \\
class & F & - & - & C, D & $\sqcap$ \\
