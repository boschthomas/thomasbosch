...
The next step, however, is to extend the \textbf{\emph{RDF Validator}} by validating any constraint type represented by any constraint language and 
...
(1) RDF data providers and consumers seeking how to ensure high quality (meta)data and thus for ways to enhance the interoperability and common understanding of RDF constraints expressible by multiple constraint languages and  
...
(2) we developed a vocabulary describing any RDF constraint type generically (section \ref{sec:vocabulary}),
(3) we show how to transform constraints, expressed by any constraint language \ms{$\alpha$}, into generically expressed constraints and into constraints represented by any other constraint language \ms{$\beta$} and why these transformations are useful (section \label{ref:transformations}), and
