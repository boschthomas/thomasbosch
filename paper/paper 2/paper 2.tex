...
We recently published a technical report\footnote{Available at: \url{http://arxiv.org/abs/1501.03933}} (serving as appendix of this paper) in which
...
We call this vocabulary the \emph{RDF Constraints Vocabulary (RDF-CV)}\footnote{Available at: \url{https://github.com/boschthomas/RDF-Constraints-Vocabulary}}.
...
Constraints can be expressed either generically (\emph{generic constraints}) by the \emph{RDF-CV}   
...
\emph{Complex constraints} encompass \emph{simple constraints} (atomic constraints) and/or further \emph{complex constraints},
...
Simple constraints may be applied to either properties (\emph{property constraints}) or classes (\emph{class constraints}).
...
Sub-classes of \emph{simple constraints} are \emph{property constraints} and \emph{class constraints} (see the \emph{RDF-CV} implementation model in figure \ref{fig:RDF-CV-implementation-model}). 
