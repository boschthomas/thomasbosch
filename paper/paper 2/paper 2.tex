...
According to the \emph{universal quantification}\footnote{Corresponds to \emph{R-91-UNIVERSAL-QUANTIFICATION-ON-PROPERTIES}} above, \emph{authors} of \emph{publications} must be \emph{persons}.
...
\tb{how are typical constraints expressed by different constraint languages}
