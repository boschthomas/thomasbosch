...
As a consequence, the \emph{Context-Specific Exclusive OR of Property Groups} constraint above is represented as a \emph{generic constraint} more intuitively and concisely (see table \ref{tab:complex-constraints-as-simple-constraints}).
...
property & D & title & - & string & = & 1 \\
		\end{tabular}
	\caption{Complex Constraints as Simple Constraints}
	\label{tab:complex-constraints-as-simple-constraints}
\end{table}
