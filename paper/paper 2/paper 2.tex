  ...
  \vspace{0cm}
	\centering
      ...
      property & Publication & author & - & Person & $\geq$ & 1 \\
		\end{tabular}
	\caption{Property Constraint}
	\label{tab:property-constraint}
\end{table}
...
\end{DL}
Mapped to the \emph{RDF-CV}, the cardinality restriction is classified as a \emph{property constraint} which holds for all individuals of the class \emph{Publication}:
...
When mapped to the \emph{RDF-CV}, the properties \emph{authorOf} and \emph{genre} are on the left side of the \emph{constraining element} \emph{$\sqsubseteq$},
