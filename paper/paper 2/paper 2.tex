...
The Enterprise, e.g. is only commended by the captains Archer, Kirk, and Picard.
...
The implementation of the automatic validation of a constraint cannot be different when it is expressed by different constraint languages.
