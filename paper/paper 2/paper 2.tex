...
In order to develop a vocabulary to describe constraints of any constraint type generically, it is needed to define the basic terminology for the formulation of constraints and to classify them. 
...
\tb{1 page / explain how typical constraints are expressed by different constraint languages}
