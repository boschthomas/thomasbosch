...
\begin{itemize}
  \item \emph{Universality:} specific constraints vs. generic constraints
	\item \emph{Complexity:} simple constraints vs. complex constraints
	\item \emph{Context:} property constraints vs. class constraints
	\item \emph{DL Expressivity:} constraints expressible in DL vs. constraints not expressible in DL
\end{itemize}
...
\begin{figure}
	...
	\caption{RDF Constraints Vocabulary (RDF-CV) - conceptual model}
	\label{fig:RDF-CV-conceptual-model}
\end{figure}

The \emph{RDF-CV} represents \emph{generic constraints} and \emph{specific constraints} are expressed by specific constraint languages.
...
Sub-classes of \ms{simple constraints} are \ms{property constraints} and \ms{class constraints} (see the RDF-CO implementation model in figure \ref{fig:RDF-CV-implementation-model}). 
...
\begin{figure}
	...
	\caption{RDF Constraints Vocabulary (RDF-CV) - implementation model}
