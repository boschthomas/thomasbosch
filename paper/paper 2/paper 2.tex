...
The idea behind this paper is to express any constraint type (corresponding to a requirement to formulate RDF constraints) in a generic way using a lightweight ontology (consisting of only a few terms).
...
\section{include this in next section}
