...
It is part of future work to finalize the implementation of all 81 constraint types in our \emph{RDF Validator}, to fully map constraint languages to RDF-CV (first and foremost DSP and OWL 2) and of course keep the framework in sync with the ongoing work in the working groups.
