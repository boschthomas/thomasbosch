...
In contrast, high-level constraint languages, which may be placed on top of \emph{SPARQL} and \emph{SPIN}, are comparatively easy to understand.
%and constraints can be formulated more concisely. 
For the formulation of constraints, it is important that the declarative language is concise and intuitive and 
for the validation of RDF data, it is important that it is translated into an implementation language like SPARQL and SPIN.
