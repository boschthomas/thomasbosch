...
we developed a lightweight vocabulary to intermediately represent constraints of any constraint type.
Even though, this vocabulary is not considered to be a constraint language,
constraints represented by the proposed vocabulary are easily understandable 
as their structure is based on common RDF terminology like classes and properties. 
