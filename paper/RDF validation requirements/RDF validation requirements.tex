...
\begin{table}[H]
    ...
    \\ \midrule
		...
		*Property Domain & $\checkmark$ & $\checkmark$ \\
		*Property Range & $\checkmark$ & $\checkmark$ \\
		...
		*Negation & \ding{55} & $\checkmark$ \\
		*Existential Quantification & $\checkmark$ & \ding{55} \\
		*Universal Quantification & \ding{55} & $\checkmark$ \\
		...
		*Transitive Object Properties & $\checkmark$ & $\checkmark$ \\
		Context-Sp. Exclusive OR of P. & \ding{55} & \ding{55} \\
		Context-Sp. Exclusive OR of P. Groups & \ding{55} & \ding{55} \\	
		Allowed Values & \ding{55} & \ding{55} \\
...
\begin{table}[H]
    ...
    \\ \midrule
		...
		*Class-Specific Property Range & $\checkmark$ & \ding{55} \\
		*Class-Sp. Reflexive Object P. & $\checkmark$ & $\checkmark$ \\
		...
		Validation Levels & $\checkmark$ & $\checkmark$ \\
		String Operations & \ding{55} & \ding{55} \\
		Context-Specific Valid Classes & \ding{55} & $\checkmark$ \\
		Context-Specific Valid Properties & \ding{55} & $\checkmark$ \\
		...
		*Exploiting Class/Property Specialization Ontology Axioms & \ding{55} & $\checkmark$ \\
