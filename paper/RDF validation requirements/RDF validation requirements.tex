...
The W3C and the DCMI working groups on RDF validation identified many RDF validation requirements. To collaboratively collect case studies, use cases, requirements, and solutions regarding RDF validation, we initiated a publicly open database of RDF validation requirements  (\url{http://purl.org/net/rdf-validation}).
The intention of this database .
...
This paper serves to evaluate to which extend each requirement is satisfied by each of these constrain languages.
