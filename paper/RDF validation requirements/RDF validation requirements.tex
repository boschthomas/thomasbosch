...
\textcolor{red}{corrections (to verify):}

\begin{DL}
$Jedi \sqsubseteq \exists attitude.\{good\} $\\
$JediStudent \sqsubseteq Jedi \sqcap \geq1 studentOf.\top \sqcap \leq1 studentOf.\top$ \\
$JediMasters \sqsubseteq Jedi \sqcap \geq1 studentOf^{-}.\top \sqcap \leq2 studentOf^{-}.\top $\\
$SuperJediMaster \sqsubseteq Jedi \sqcap  \geq3 studentOf^{-}.\top $
\end{DL}
...
not sure if this should be rather\\
$parentOf \sqsubseteq childOf^{-}$ \\
\end{DL}
...
\an{I think we should use the existential quantifier instead of the universal quantifier!?}
\begin{DL}
$A \sqsubseteq \exists name.xsd:string$ \\
$B \sqsubseteq \exists givenName.xsd:string$ \\
$D \sqsubseteq \exists mbox.xsd:string$ \\
$Human \sqsubseteq C \sqcap D$ \\
\end{DL}
...
\begin{DL}
A $\equiv$ $\exists$ foaf:name . xsd:string \\
B $\equiv$ $\exists$ foaf:givenName . xsd:string \\ 
Human $\sqsubseteq$ ($\neg$ A $\sqcap$ B) $\sqcup$ (A $\sqcap$ $\neg$ B) \\
\end{DL}
...
Literal Pattern Matching & \ding{55} & $\checkmark$ & $\checkmark$ & \ding{55} & \ding{55} & $\checkmark$ \\
Negative Literal Pattern Matching & \ding{55} & $\checkmark$ & $\checkmark$ & \ding{55} & \ding{55} & $\checkmark$ \\
