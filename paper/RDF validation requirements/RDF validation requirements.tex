...
*Minimum Unqualified Cardinality & $\geq$ & $\geq$ \\
*Minimum Qualified Cardinality & $\geq$ & $\geq$ \\
*Maximum Unqualified Cardinality & $\leq$ & $\leq$ \\
*Maximum Qualified Cardinality & $\leq$ & $\leq$ \\
...
Literal Value Comparison & $>$ or $\geq$ or $<$ or & $>$, $\geq$, $<$, $\leq$, =, $\ne$ \\
                         & $\leq$ or = or $\ne$ & \\
