...
class & Jedi & - & - & $\exists$ laserSwordColor . LaserSwordColor & $\neg$ & - \\
class & LaserSwordColor & - & - & $\{blue\}$, $\{green\}$, $\{white\}$ & $\sqcup$ & - \\
\end{gcotable}
...
\begin{gcotable}
class & Jedi & laserSwordColor & - & - & default values & 'blue' \\
class & Jedi & numberLaserSwords & - & - & default values & '1' \\
class & Sith & laserSwordColor & - & - & default values & 'red' \\
class & Sith & numberLaserSwords & - & - & default values & '2' \\
\end{gcotable}
...
\begin{gcotable}
class & $\top$ & foaf:name & - & - & language tag exact cardinality & 1 \\
\end{gcotable}
...
\begin{gcotable}
class & $\top$ & shoeSize & - & xsd:nonNegativeInteger & value valid for datatype & - \\
\end{gcotable}
...
\tb{I do not understand the relation of this example to this constraint}
...
\begin{gcotable}
class & \{Meg\} & hasAge & - & - & = & "17"$\hat{\ } \hat{\ }$ xsd:integer \\
\end{gcotable}
...
\begin{DL}
Not sure about if this constraint is expressible in DL, I think not!
\end{DL}

\an{not sure!}

\begin{DL}
$\top$ $\sqsubseteq$ $\exists$ likes . Self
\end{DL}
...
class & $\top$ & - & - & $\top$, $\exists$ likes . Self & $\sqsubseteq$ \\
\end{gcotable}
...
\begin{DL}
$(\textsf{funct } \textsf{hasSSN})$
\end{DL}

\begin{gcotable}
property & $\top$ & hasSSN & - & - & functional & - \\
\end{gcotable}
