...
%                                     \toctitle is used
%
\author{Thomas Bosch\inst{1} \and Andreas Nolle\inst{2} \and Erman Acar\inst{3} \and Kai Eckert \inst{3}}
%
...
%, and distinguish between OWL 2 QL and OWL 2 DL constructs to express particular constraints.
...
\begin{gcotable}
property & $\exists$ marriedTo . Self & knows & - & Self & $\exists$ \\
...
\begin{gcotable}
property & $\exists$ marriedTo . Self & knows & - & Self & $\exists$ \\
class & $\neg$ $\exists$ marriedTo . Self & - & - & $\exists$ knows . Self & $\neg$ \\
class & Person & - & - & Person, $\neg$ $\exists$ marriedTo . Self & $\sqsubseteq$ \\
\end{gcotable}
...
class & $\geq$1 & - & - & xsd:nonNegativeInteger & $\geq$ & 1 \\
class & $\leq$23 & - & - & xsd:nonNegativeInteger & $\leq$ & 23 \\
\end{gcotable}
...
\begin{gcotable}
class & $\top$ & - & - & - & HTTP URI Scheme Violation & - \\
\end{gcotable}
...
*Property Domains & \ding{55} & $\checkmark$ & $\checkmark$ & \ding{55} & \ding{55} & $\checkmark$ \\
*Property Ranges & \ding{55} & $\checkmark$ & $\checkmark$ & \ding{55} & \ding{55} & $\checkmark$ \\
...
*Existential Quantifications & \ding{55} & $\checkmark$ & \ding{55} & $\sim$ & $\sim$ & $\checkmark$ \\
*Universal Quantifications & \ding{55} & $\checkmark$ & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
...
Ordering & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
...
Use Sub-Super Relations in Validation & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
...
*Class-Specific Irreflexive Object Properties & \ding{55} & $\checkmark$ & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
Provenance & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
Data Model Consistency & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
Structure & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\  
Labeling and Documentation & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
Vocabulary & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
HTTP URI Scheme Violation & \ding{55} & \ding{55} & \ding{55} & \ding{55} & \ding{55} & $\checkmark$ \\
\end{evaluation-overall}
...
*Property Domains & $\checkmark$ & $\sim$ & $\checkmark$ \\ 
*Property Ranges & $\checkmark$ & $\sim$ & $\checkmark$ \\ 
...
*Existential Quantifications & $\checkmark$ & $\checkmark$ & $\checkmark$ \\  
*Universal Quantifications & $\checkmark$ & $\checkmark$ & $\checkmark$ \\  
...
Ordering & $\checkmark$ & $\checkmark$ & \ding{55} \\ 
...
Use Sub-Super Relations in Validation & $\checkmark$ & $\checkmark$ & \ding{55} \\ 
*Cardinality Shortcuts & $\checkmark$ & $\checkmark$ & $\checkmark$ \\  
Aggregations & $\checkmark$ & $\checkmark$ & \ding{55} \\ 

*Class-Specific Irreflexive Object Properties & $\checkmark$ & $\sim$ & $\checkmark$ \\
Provenance & \ding{55} & $\checkmark$ & \ding{55} \\
Data Model Consistency & $\sim$ & \ding{55} & \ding{55} \\
Structure & $\sim$ & \ding{55} & \ding{55} \\ 
Labeling and Documentation & $\sim$ & \ding{55} & \ding{55} \\
Vocabulary & \ding{55} & $\checkmark$ & \ding{55} \\
HTTP URI Scheme Violation & \ding{55} & $\checkmark$ & \ding{55} \\
\end{evaluation-generic}
...
\begin{table}[H]
    ...
    \\ \midrule
		...
		*Reflexive Object Properties & $\checkmark$ & $\checkmark$ \\
		*Irreflexive Object Properties & \ding{55} & \ding{55} \\
		Disjoint Properties & \ding{55} & \ding{55} \\
		Disjoint Classes & \ding{55} & $\checkmark$ \\
		Context-Sp. Property Groups & $\checkmark$ & $\checkmark$ \\
		...
		*Universal Quantifications & \ding{55} & $\checkmark$ \\
		*Minimum Unqualified Cardinality & $\checkmark$ & $\checkmark$ \\
		*Minimum Qualified Cardinality & $\checkmark$ & $\checkmark$ \\
		*Maximum Unqualified Cardinality & \ding{55} & $\checkmark$ \\
		*Maximum Qualified Cardinality & \ding{55} & $\checkmark$ \\
		*Exact Unqualified Cardinality & $\checkmark$ & $\checkmark$ \\
		*Exact Qualified Cardinality & $\checkmark$ & $\checkmark$ \\
		*Transitive Object Properties & $\checkmark$ & $\checkmark$ \\
		Context-Sp. Exclusive OR of P. & \ding{55} & $\checkmark$ \\
		Context-Sp. Exclusive OR of P. Groups & \ding{55} & $\checkmark$ \\	
		Allowed Values & \ding{55} & $\checkmark$ \\
		Not Allowed Values & \ding{55} & $\checkmark$ \\
		...
		Repeatable Properties & $\checkmark$ & \ding{55} \\
		Negative Property Constraints & \ding{55} & $\checkmark$ \\
		*Individual Equality & $\checkmark$ & \ding{55} \\
...
\begin{table}[H]
    ...
    \\ \midrule
		...
		*Class-Sp. Reflexive Object P. & $\checkmark$ & $\checkmark$ \\
		...
		IRI Pattern Matching & \ding{55} & $\checkmark$ \\
		Literal Value Comparison & \ding{55} & \ding{55} \\
		Ordering & $\checkmark$ & \ding{55} \\
		Validation Levels & $\checkmark$ & \ding{55} \\
		...
		*Default Values & $\checkmark$ & $\checkmark$ \\
		...
		Language Tag Matching & $\checkmark$ & \ding{55} \\
		...
		Use Sub-Super Relations in Validation & \ding{55} & $\checkmark$ \\
		*Cardinality Shortcuts & $\checkmark$ & $\checkmark$ \\ 
		Aggregations & \ding{55} & \ding{55} \\
		*Class-Specific Irreflexive Object Properties & \ding{55} & $\checkmark$ \\
		Provenance & $\checkmark$ & $\checkmark$ \\ 
		...
		HTTP URI Scheme Violation & \ding{55} & $\checkmark$ \\
    \bottomrule
    \end{tabular}
...
%Recursive Queries & \ding{55} \\ 
%Individual Inequality & $\checkmark$ \\ 
%*Equivalent Properties & \ding{55} \\ 
%Property Assertions & \ding{55} \\ 
%Data Property Facets & \ding{55} \\ 
%Literal Pattern Matching & \ding{55} \\ 
%Negative Literal Pattern Matching & \ding{55} \\ 
...
%Literal Ranges & \ding{55} \\ 
%Negative Literal Ranges & \ding{55} \\ 
...
%*Exploiting Class/Property Specialization Ontology Axioms & \ding{55} \\ 
...
*Subsumption & $\sqsubseteq$ & sub-classes \\
*Class Equivalence & $\equiv$ & equivalent classes \\
*Sub Properties & $\sqsubseteq$ & sub-properties \\
*Property Domain & $\exists$, $\sqsubseteq$ & property domain \\
*Property Range & $\sqsubseteq$, $\forall$ & property range \\
*Inverse Object Properties & inverse & inverse properties \\
%*Symmetric Object Properties & $\equiv$, inverse & symmetric \\
*Symmetric Object Properties & symmetric & symmetric properties \\
%*Asymmetric Object Properties & $\sqsubseteq$, inverse & asymmetric \\
*Asymmetric Object Properties & asymmetric & asymmetric properties \\
%*Reflexive Object Properties & $\exists$, $\sqsubseteq$ & \textcolor{green}{reflexive} \\
*Reflexive Object Properties & reflexive & reflexive properties \\
%*Irreflexive Object Properties & $\exists$, $\neg$, $\sqsubseteq$ & irreflexive \\
*Irreflexive Object Properties & reflexive, $\neg$ & irreflexive properties \\
Disjoint Properties & $\sqsubseteq$, $\neg$ & $\ne$ \\
Disjoint Classes & $\sqcap$, $\sqsubseteq$ & $\ne$ \\
Context-Sp. Property Groups & $\sqcap$ & property group \\
Context-Sp. Inclusive OR of P. & $\sqcup$ & inclusive or of properties \\
Context-Sp. Inclusive OR of P. Groups & $\sqcup$, $\sqcap$ & inclusive or of property groups, \\
                                                          && property group \\
Recursive Queries & - & recursive \\
Individual Inequality & $\ne$ & \\
*Equivalent Properties & $\equiv$ & equivalent properties \\
Property Assertions & = or $\ne$ & \\
Data Property Facets & - & XSD or SPARQL constraining facets \\
                        && examples: regex, xsd:pattern, ... \\
Literal Pattern Matching & - & regex or xsd:pattern \\
Negative Literal Pattern Matching & - & regex or xsd:pattern, $\neg$ \\ 
*Object Property Paths & $\sqsubseteq$ & property paths \\
...
*Minimum Unqualified Cardinality & $\geq$ & \\
*Minimum Qualified Cardinality & $\geq$ & \\
*Maximum Unqualified Cardinality & $\leq$ & \\
*Maximum Qualified Cardinality & $\leq$ & \\
*Exact Unqualified Cardinality & $\geq$, $\leq$, $\sqcap$ & = \\
*Exact Qualified Cardinality & $\geq$, $\leq$, $\sqcap$ & = \\
*Transitive Object Properties & $\sqsubseteq$ & transitive properties \\
Context-Sp. Exclusive OR of P. & $\neg$, $\sqcap$, $\sqcup$ & XOR of properties \\
Context-Sp. Exclusive OR of P. Groups & $\neg$, $\sqcap$, $\sqcup$ & XOR of property groups \\
                                                                 & & property group \\
Allowed Values & $\sqcup$ & allowed values \\
Not Allowed Values & $\sqcup$, $\neg$ & not allowed values \\
%Literal Ranges & $\geq$, $\leq$, $\sqcap$ &  \\ 
Literal Ranges & - & xsd:minInclusive \\
               & & xsd:maxInclusive \\
%Negative Literal Ranges & $\geq$, $\leq$, $\sqcap$, $\neg$ & \\  
Negative Literal Ranges & - & xsd:minInclusive \\
                        & & xsd:maxInclusive \\
Required Properties & $\exists$ & required properties \\	
...
Optional Properties & $\exists$, $\sqsubseteq$ & optional properties \\
Repeatable Properties & $\geq$ & repeatable properties \\
Negative Property Constraints & $\neg$, $\exists$ & negative properties \\
*Individual Equality & = & \\
*Functional Properties & functional & functional properties \\ 
*Inverse-Functional Properties & inverse, functional & inverse functional properties \\
*Value Restrictions & $\exists$ & value restriction \\
*Self Restrictions & $\exists$ & self restriction \\
Primary Key Properties & inverse, functional & keyfor or primary key \\
*Class-Specific Property Range & $\sqsubseteq$, $\exists$, $\neg$ & property range \\
*Class-Sp. Reflexive Object P. & reflexive & reflexive properties \\
Membership in Controlled Vocabularies & $\forall$, $\sqcap$, $\sqcup$ & membership in \\
  && controlled vocabularies \\
IRI Pattern Matching & - & IRI pattern matching \\
Literal Value Comparison & $>$ or $\geq$ or $<$ or & \\
                         & $\leq$ or = or $\ne$ & \\
Ordering & - & ordered properties, \\
            && ordered values \\ 
Validation Levels & - & validation level \\ 
String Operations & - & SPARQL string operations \\ 
  && examples: STRLEN, \\ 
	&& SUBSTR, CONTAINS \\
...
Mathematical Operations & - & example: multiplication \\
...
HTML Handling & - & html \\
Conditional Properties & $\sqsubseteq$ & conditional properties \\
Recommended Properties & - & recommended properties \\
Handle RDF Collections & - & actions on RDF collections \\
Value is Valid for Datatype & - & value is valid for datatype \\
Use Sub-Super Relations in Validation & - & not redundant properties \\
*Cardinality Shortcuts & & optional \& non-repeatable properties, \\
                       & & optional \& repeatable properties, \\
											 & & mandatory \& non-repeatable properties, \\
											 & & mandatory \& repeatable properties \\
