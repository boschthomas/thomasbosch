...
Context-Sp. Exclusive OR of P. & \ding{55} & $\sim$ & \ding{55} & & $\checkmark$ & $\checkmark$ \\
...
\textcolor{blue}{*Cardinality Shortcuts} & $\checkmark$ & $\checkmark$ & \ding{55} & $\sim$ & $\checkmark$ & $\checkmark$ \\
\end{evaluation}
