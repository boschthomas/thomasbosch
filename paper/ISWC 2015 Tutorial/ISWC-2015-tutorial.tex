...
Using Disco, such data sets which are often used in different domains like the social, ecomical and behavioral sciences can be published as Linked Data. 
...
It is based on the metadata standard DDI (Data Documentation Initiative) which enables the representation of the observation and measurement of human activity and which is often used in domains like the social, ecomical and behavioral sciences. 
