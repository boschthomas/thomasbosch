...
Jedi masters are also Jedis which are also feeling the force.
...
These class assignments can be either explicitly stated or implicitly inferred when inferencing is performed before validating the data.
...
Qualified and Unqualified Cardinality Restrictions
...
\begin{itemize}
  ...
  \item (TBox) Reasoning in OWL 2 QL is in PTIME, so rewriting of queries to receive “complete“ results is in this complexity.
