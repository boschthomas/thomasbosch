...
Consider the following DL knowledge base $\mathcal{K}$ \footnote{ The \emph{knowledge base} or the list of \emph{what is known} is a collection of formal statements in that formal language.}:
\begin{center}
\begin{DL} 
