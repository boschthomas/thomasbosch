...
%
%
\title{Effects on Complexity of RDF Validation with and without Reasoning}
%
...
and constraint validation are indeed very closely related. \an{maybe we can use also the term 'User-defined Consistency' described in \url{http://www.aifb.kit.edu/images/d/d2/2005_925_Haase_Consistent_Evol_1.pdf} as a further 'hook' to establish our approach?}
