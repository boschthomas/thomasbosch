...
\begin{figure}
	\centering
		\includegraphics[width=0.80\textwidth]{complexiity_and_expressivity.png}
...
as we cannot measure  user-friendliness we could divide the DSCLs into 2 classes:
high-level
low-level

You cannot formally measure user-friendliness as in the case of expressivity and complexity. However I mentioned it, since when Kai had introduced me the idea of this collaboration, it was the first thing he had mentioned : ``Sparql is cumbersome or not friendly while languages like SPIN, DSP, Shex are from validation point of view". I don't mean that this must come forward as one of the main points in the paper, but in one of those introductory paragraphs it can be told. We can also informally, time to time, touch this the paper, e.g., "In the case of rather user friendly languages like blabla etc.", since this is also something that ppl might care about. (If this is not too obvious or verbose to  RDF validating guys or some other guys)
