...
For this reason, the technical report also contains mappings to \emph{DL} to logically underpin each requirement and to determine which \emph{DL} constructs are needed to express each constraint type.
...
\textcolor{red}{eher untergeordnete aspekte: semantics}
...
\textcolor{red}{tabelle sortieren / es muss klarer sein was das für ein \% ist / zu lang / ordering streichen / merge tables / absolute numbers in brackets}
...
\textcolor{red}{section motivieren}
...
\textcolor{red}{(3) The major shortcoming of classical constraint languages is \emph{redundancy} which is solved by \emph{OWL 2} with its open-world semantics (see first paragraph in Section \ref{motivation}). }
...
\textcolor{red}{besser motivieren}
