...
as OWL reasoning requires {\em OWA}, {\em nUNA} and RDF validation is based on {\em UNA} (different names represent different objects),
{\em CWA} (a statement is inferred to be false if it cannot be proved to be true).
We classify constraints according to the dependency on CWA and UNA:
\begin{enumerate}
