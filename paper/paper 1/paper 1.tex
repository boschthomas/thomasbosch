...
for impossibilities, i.e., constraint violations. \an{what do you mean with this sentence?}

\begin{itemize}
	\item inferencing as a pre/post validation step \an{why post?}
...
Then I wonder what would be the situation if we recommend that reasoning should happen prior to validation. Reasoning will 'fix' the data in some case (R-25 and R-28) but it would make the data more 'redundant' in others (R-224). \an{I can't follow...}
...
\er{Now it is completely rewritten. Feel free to touch and change anything.}
...
personDescriptionTemplate
    ...
    dsp:statementTemplate [
        ...
        dsp:literalConstraint [
            ...
            dsp:literal "green" ;
            dsp:literal "white"] ] .
\end{ex} \an{One constraint language is IMHO enought... Maybe not!?}
...
:CC2 rdfs:subClassOf [
    ...
    owl:allValuesFrom xsd:boolean ] .
\end{ex} \an{Formulars in DL would be nice... ;)}
