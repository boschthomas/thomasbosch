...
\begin{complexity}
validation by query answering without reasoning & LOGSPACE (or rather in AC$^0$ ) \\
OWL 2 QL reasoning & PTIME \\
OWL 2 DL reasoning & \\
validation by query answering with OWL 2 QL reasoning & PTIME \\
validation by query answering with OWL 2 DL reasoning & \\
\end{complexity}
