...
If something is a book, e.g., it cannot be a journal article (\ms{Male $\sqcap$ Female $\sqsubseteq$ $\perp$}).
For this {\em disjoint classes} constraint, It does not make any difference if the semantics CWA/UNA or OWA/nUNA is taken,
as all information needed to validate this constraint is explicitly available in both cases. 
