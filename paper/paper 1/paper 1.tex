...
Within the validation environment, we fully implemented an automatic validation of all OWL 2 DL\footbote{and therefore all OWL 2 QL constructs} constructs. 
