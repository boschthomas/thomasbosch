...
\begin{itemize}
	...
	\item \textcolor{blue}{suggestion of Kai: expressivity in motivation section (or conclusion)} 
	\item \textcolor{blue}{Kai: expressivity scores do not have any message} 
\end{itemize}
