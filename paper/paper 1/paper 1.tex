...
Reasoning may be a pre validation step, either in order to infer triples resolving constraint violations 
or in order to infer triples for which constraints are violated.
