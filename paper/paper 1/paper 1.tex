...
Numbers in parentheses in table cells indicate the number of constraint types which may be expressed by a particular constraint language - either by limitations, workarounds, or extensions.  
