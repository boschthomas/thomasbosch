...
%we associate this constraint with the super-class {\em Publication} and do not have to assign it to each of its sub-classes (which would lead to redundancy).
