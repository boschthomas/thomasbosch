...
Let us call the set of all constraints as $\mathcal{C}$We distinguish two disjoint sub-classes of constraints:
\begin{itemize}
...
According to our evaluation of requirements to formulate RDF constraints, we identified four main ways of validating the two constraint classes \emph{constraints without reasoning} and \emph{constraints with reasoning} assigned to three constraint classes:
...
as in case of \emph{cardinality shortcuts}, e.g., OWL2 DL reasoning can be done on cardinality restrictions.
