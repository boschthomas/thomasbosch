...
{\em Literal Pattern Matching}\footnote{See R-44-PATTERN-MATCHING-ON-RDF-LITERALS.}, restricting literals to match given patterns,
...
Note that $C_R$ corresponds to axioms in OWL  e.g., subsumption, sub-properties, cardinality restrictions, existential, and universal restrictions.
...
{\em Sub Properties}, e.g., are constraints for which reasoning may be performed.
