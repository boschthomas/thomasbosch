...
The subsequent steps are needed to have an idea about the performance (i.e. computational complexity) to validate simple (atomic) and complex (composed) constraint types:
\begin{enumerate}
	...
	\item Since the combination of DL constructs of a constraint type determines its complexity,  by mapping each constraint we get an idea of the complexity for each constraint type in worst case.
\end{enumerate}
