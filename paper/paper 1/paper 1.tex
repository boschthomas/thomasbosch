...
(3) how efficient in terms of runtime reasoning is performed.
...
For each constraint type we investigate how efficient in terms of runtime reasoning is performed.
...
Using these findings, we determine for the most common constraint languages which constraint types they are able to express.
Having this information enables systems to recommend the right language to formulate constraints depending on individual use cases of users.
...
(3) For each constraint type we examine if validation results depend on different underlying semantics,
    ...
    how efficient in terms of runtime reasoning is performed.
...
\emph{DL} provides the foundational basis for \emph{OWL}.  
