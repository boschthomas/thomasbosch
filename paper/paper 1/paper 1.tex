...
(2) $\overline{\mathcal{CT}_{R}}$  denotes the complement that is the set of constraint types for which reasoning cannot be done or which do not contribute to improve data quality in any obvious sense.
...
$\overline{\mathcal{CT}_{R}}$ is the set of constraint types for which reasoning cannot be done or which do not contribute to improve data quality in any obvious sense.
...
default triples for keywords like {\small\ms{(keyword(This-} \ms{Paper,"Semantic Web")}} could be inferred.
