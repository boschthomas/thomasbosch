...
conciseness & \ding{55} & $\checkmark$ & $\sim$ & $\checkmark$ & \ding{55} \\
...
In most cases, the same constraints can be expressed more concise in OWL 2 and ShEx than in DSP and SPIN\footref{footnoteIntuitivenessConciseness}.
