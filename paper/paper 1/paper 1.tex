...
\begin{eqnarray*}
\emph{Expr(DSP):} DSP \succ SPIN \succ OWL2-DL \succeq ShEx \succ ReSh \succ OWL2QL \\ 
\emph{Expr(OWL2DL):} OWL2DL \succ SPIN \succ OWL2QL \succ DSP \succ ShEx \succ ReSh \\
\emph{Expr(OWL2QL):} OWL2QL \succeq OWL2DL \succ SPIN \succ ShEx \succ ReSh \succ DSP\\
\emph{Expr(ReSh):} ReSh \succ SPIN \succ ShEx \succ OWL2-DL \succ DSP \succ OWL2QL \\
\emph{Expr(ShEx):} ShEx \succ SPIN \succ OWL2DL \succ DSP \succ ReSh \succ OWL2QL \\
\emph{Expr(SPIN):} SPIN \succ OWL2DL \succ ShEx \succ OWL2QL \succ DSP \succ ReSh \\ 
\end{eqnarray*}
