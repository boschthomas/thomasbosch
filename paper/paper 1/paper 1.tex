...
32 of the overall 82 constraint types are $\mathcal{R}$ constraint types.
...
42 of the overall 82 constraint types are $\overline{\mathcal{R}}$ constraint types.
\end{enumerate}
...
11 of 32 $\mathcal{R}$ constraint types are representable by the less expressive but better performing \emph{OWL 2 QL}.
18 $\mathcal{R}$ constraint types, in contrast, are not expressible by \emph{OWL 2 QL} and therefore the more expressive but less performing \emph{OWL 2 DL} is used.
...
11 of 32 $\mathcal{R}$ constraint types are $\mathcal{R}_{QL}$ constraint types.
...
29 of 32 $\mathcal{R}$ constraint types are $\mathcal{R}_{DL}$ constraint types.
...
Some of these constraint types can also be represented by classical constraint languages.
