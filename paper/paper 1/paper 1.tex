...
\begin{table}[H]
	...
	\label{tab:constraint-type-specific-expressivity}
\end{table}
Table \ref{tab:constraint-type-specific-expressivity} displays how many of the overall 42 $\overline{\mathcal{CT}_R}$ and 32 $\mathcal{CT}_R$ constraint types are expressible by listed constraint languages.
...
Numbers in parentheses indicate the amount of constraint types which may be expressed by a particular constraint language - either by limitations, workarounds, or extensions.  
...
"which language could contain the whole \emph{DSP} or  could be used instead?". 
