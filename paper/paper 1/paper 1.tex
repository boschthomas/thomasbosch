...
% -----
Rdf validation gained speed as a research field in recent years, as a result of a common need.  For instance, libraries are used to publish data in form of XML documents for a long time.
