...
The database connects requirements to use cases, case studies and implementations and forms the basis of this paper in which we will present the key findings we got from the analysis of the RDF validation requirements. 
