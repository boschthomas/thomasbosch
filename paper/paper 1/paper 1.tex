...
\begin{itemize}
	\item \ms{ExprR-OWL2QL}: OWL 2 QL reasoning axioms
	\item \ms{ExprR-OWL2DL}: OWL 2 DL reasoning axioms
	\item \ms{ExprR}: reasoning constraints not supported by OWL
	\item \ms{ExprC}: constraints without reasoning
\end{itemize}

\ms{ExprR-OWL2QL} axioms can be expressed by other DSCLs than OWL 2, although, there is no reasoning implementation available yet.

\begin{evaluation}
OWL 2 QL reasoning axioms (11) & 0 & 11 & 11 & 0(2) & 1 & 11 \\
OWL 2 DL reasoning axioms (18) & 7 & 18 & 0 & 9 & 8(1) & 18 \\
reasoning constraints not supported by OWL 2 (4) & 1 & 0 & 0 & 2 & 2 & 4 \\ 
constraints without reasoning (41) & 6 & 18(4) & 7(4) & 8 & 12 & 40(1)\\
\end{evaluation}
...
\begin{itemize}
	\item ExprC: DSP $\subset$ OWL2-QL $\subset$ ReSh $\subset$ ShEx $\subset$ OWL2-DL $\subset$ SPIN
\end{itemize}

\begin{itemize}
	\item SPARQL is the most (without reasoning) expressive DSCL
\end{itemize}
