...
To evaluate RDF validation requirements, we had group constraints under two  main classes: \emph{constraints without reasoning} and \emph{constraints with reasoning}. In addition, to have a further evaluation and to refer easily, we divide the latter into two classes (not disjoint). Overall, we have the following.
