...
the universal restriction \ms{Book $\sqsubseteq$ $\forall$ identifier.ISBN} which ensures that \emph{books} can only have valid \emph{ISBN} identifiers, 
...
which cannot be expressed by \emph{OWL 2 QL}, but by \emph{OWL 2 DL} \cite{owl2profiles2008}:
\begin{ex}
[ a owl:Restriction ;
