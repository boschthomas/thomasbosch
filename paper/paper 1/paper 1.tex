...
Reasoning may cause additional constraint violations needed to enhance data quality, e.g., as books are publications, constraints on publications are also validated for books (e.g. each publication must have a publisher).
