...
This way, \emph{property domains and ranges, universal and existential quantifications, minimum, maximum, and exact cardinality restrictions} are defined for each object and data property of vocabularies against which one wish to validate.
...
reasoning constraints / sub-classes / sub-properties
