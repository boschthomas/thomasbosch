...
We evaluated multiple aggregated and person-level data sets 

the most important constraints and constraint types 



- Data Cube: XXXXX
- 3 thesauri: The Thesaurus for the Social Sciences (TheSoz), STW Thesaurus for Economics of the ZBW, and the AGROVOC thesaurus of FAO
- Disco: 5 series like EU-SILC 
- PHDD
- XKOS

in order to ensure high quality of existing large real world data sets

Exported from Missy, we validated \emph{Disco} person-level data containing overall XX resources (5 series, XX studies, XX data sets, XX theoretical concepts, XX variables, XX questions, XX codes, XX category statistics (frequencies), and XX summary statistics).

triple store\footnote{\textcolor{red}{\url{http://multiweb.gesis.org/openrdf-workbench/}}}

The correctness of $\mathcal{C}_{C}$ constraints, i.e., the gold standard has been designed by a SBE domain expert.
