...
are very interested in having their data be discovered and used by exposing their metadata (e.g. about unemployment rates or income\ke{wieso ist das metadata? Ich würde generell auch im text bei data bleiben, es sei denn, die unterscheidung von data und metadata ist relevant.}) within the Web of Linked Data.
...
\ke{in guter tradition unserer arbeitsgruppe würde ich mich als senior researcher um die einleitung kümmern, die gefällt mir so nicht}
...
\section{Vocabularies to Represent Metadata and Data in RDF\ke{ganz schlechte überschrift... vorschlag: Examined Vocabularies oder Common Vocabularies in SBE sciences}}
