...
2/3 of all violations are caused by \emph{warning constraints} which are only 10\% of all constraints. 
Only 6\% of the violations are caused by \emph{error constraints} which are 49\% of all constraints.
1/3 of all violations are raised by informational constraints.
This means that in general, data quality is high with regard to the severity level of constraints.
