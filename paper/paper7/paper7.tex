...
The \emph{qb:DataStructureDefinition} contains metadata of the data collection.
...
\emph{PHDD} represents data in tabular format in RDF enabling further aggregations and calculations. 
