...
On the three vocabularies (\emph{Disco}, \emph{QB}, \emph{SKOS}), we identified and classified 114 of constraints,\footnote{\url{https://github.com/boschthomas/rdf-validation/tree/master/constraints}} as described before. We evaluated the data quality of 15,694 data sets (4.26 billion triples) of \emph{SBE} research data using these vocabularies, obtained from 33 SPARQL endpoints.
...
In close collaboration with several \emph{SBE} domain experts, we formulated 213 constraints\footnote{The second appendix of this paper, in which we describe each vocabulary-specific constraint in detail, is available at: \url{http://arxiv.org/abs/1504.04479} \cite{BoschZapilkoWackerowEckert2015}}
 of 53 different types on three different vocabularies (\emph{Disco}, \emph{QB}, and \emph{SKOS}) and classified them according to the complexity level of their type and their severity level. 
