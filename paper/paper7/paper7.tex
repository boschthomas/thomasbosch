...
\title{Classification of RDF Constraint Types Ensuring High Quality of Metadata and Data}
\subtitle{}
...
(1) to classify RDF constraints to evaluate the quality of (meta)data which may be represented by any vocabulary and 
(2) to classify RDF constraint types which in most cases correspond to RDF validation requirements.
...
we prove the claim that the developed classification system perfectly applies vocabulary-independent and therefore to prove the generality of the proposed classification system.
...
(2) which sets of constraints (associated with particular severity levels) encompass the most/fewest violated constraints.
...
The \textbf{contribution} of this paper is the development of a system 
\begin{enumerate}
	\item to classify RDF constraints to evaluate the quality of metadata and data which may be represented by any vocabulary and 
	\item to classify RDF constraint types which in most cases correspond to RDF validation requirements\footnote{For simplicity reasons, we use the terms \emph{constraint types} and \emph{constraints} instead of \emph{RDF constraint types} and \emph{RDF constraints} in the rest of the paper} (section \ref{classification} - \ref{complex-constraint-types}).
\end{enumerate}
