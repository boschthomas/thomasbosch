...
As, e.g., 18\% of the Disco, 100\% of the QB, and 21\% of the \emph{SKOS} violations are caused by complex constraints,  
we calculate that 46.6\% of the violations are raised by complex constraints of all vocabularies.
