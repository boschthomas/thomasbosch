...
(1) variable definitions are available

(2) if code lists are properly structured

(3) if for each code an associated category (a human-readable label) is specified.
