...
%    \\  \cmidrule{2-7}
    ...
    \\ \midrule
		...
		\hline
		\emph{CV (}$\mathcal{CT}_{C}$\emph{)} & 18.3\% & 45,634,084 (\textbf{100\%}) & 1,185,982 (21.4\%) & 47,472,846 (\textbf{86.7\%}) \\
		\emph{CV (}$\mathcal{CT}_{S}$\emph{)} & 15.7\% & 0 (0\%) & 4,355,006 (\textbf{78.6\%}) & 4,915,863 (9\%) \\
		\emph{CV (}$\mathcal{CT}_{B}$\emph{)} & \textbf{66.1\%} & 1,777 (0\%) & 0 (0\%) & 2,363,142 (4.3\%) \\
		%\hline
