...
By applying the proposed classification system to several vocabularies to represent both metadata and data, we show its generality \cite{BoschZapilkoWackerowEckert2015}.

\tb{Depending on individual use cases, validation environments should enable users to select which constraints to validate against.
For some use cases, validating $\mathcal{CT}_{B}$ constraints may be more important than validating $\mathcal{CT}_{S}$ or $\mathcal{CT}_{C}$ constraints.}
...
\tb{es werden große datenbestände untersucht um ein besseres verständnis zu bekommen welche art von constraints für welche vokabulare am häufigsten verletzt werden und welche severity levles für welche vokabulare am häufigsten verletzt werden}
