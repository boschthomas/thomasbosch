...
(e.g., constraints on graph-based structures}).
...
In close collaboration with several SBE domain experts, we formulated 246 constraints\footnote{The first appendix of this paper describing each constraint in detail is available at: \url{http://arxiv.org/abs/1504.04479} \cite{BoschZapilkoWackerowEckert2015}}
...
For 114 of these constraints, we evaluated\footnote{The second appendix of this paper describing the evaluation in detail is available at: \url{http://arxiv.org/abs/1504.04478} \cite{BoschZapilkoWackerowEckert2015-2}.}
