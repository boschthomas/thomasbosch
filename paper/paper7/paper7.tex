...
Summary statistics types like minimum, maximum, and arithmetic mean, e.g., are maintained within a controlled vocabulary.  
...
If a dimension property has a \emph{qb:codeList},
