...
\ke{Alle vokabulare in section "vocabularies" eingeführt?}
...
\ke{Prozentwerte kann man nicht normalisieren... Du musst auch nicht erklären, wie man normalisiert, schon gar nicht mit Rechenbeispiel. "... and 10 million Disco triples. Therefore, we only use normalized relative values representing the percentage of constraints and constraint violations belonging to the respective class.}
