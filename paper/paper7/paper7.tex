...
The data could be either represented in records with character-separated values (CSV) or in records with fixed length. 
The two-dimensional table about \emph{formal childcare} can be downloaded as CSV file\footnote{CSV file and complete PHDD representation available at: \url{XXXXX}}. 
