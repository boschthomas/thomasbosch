...
\begin{itemize}
  \item Microdata Information System (Missy)
	...
	\end{itemize}
	\item DDA and SND SPARQL endpoint\footnote{\url{http://ddi-rdf.borsna.se/}} 
	\begin{itemize}
		\item triples: 2,271,415
		\item studies: 1,490
		\item universes: 10,188
		\item questions: 139,237
		\item variables: 80,070
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Nomenclature d'activités française (NAF)\footnote{\url{http://rdf.insee.fr/codes/index.html}}: French classification expressed in XKOS. the French refinement of the NACE, because it has explanatory notes.
	\item Nomenclature des Professions et Catégories Socioprofessionnelles (PCS)\footnote{\url{http://rdf.insee.fr/codes/index.html}}: French classification expressed in XKOS.
	\item Nomenclature des catégories juridiques (CJ)\footnote{\url{http://rdf.insee.fr/codes/index.html}}: French classification expressed in XKOS.
