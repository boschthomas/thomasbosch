...
The fact that regardless of the language 1/2 of all constraints are \emph{informational} indicates that the purpose of constraints for users is mostly just to point to desirable but not necessary data improvements in terms of syntax and semantics of vocabularies. 

\begin{hyp}
Regardless of the type of the used language, there are only a few violations raised by important constraints which stands for good data quality in general.
