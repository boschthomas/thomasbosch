...
%Table \ref{tab:evaluation-constraints-expressivity-severity} shows the relations between the severity level of all 115 constraints and the classification of their types according to the expressivity of constraint languages in percent.
