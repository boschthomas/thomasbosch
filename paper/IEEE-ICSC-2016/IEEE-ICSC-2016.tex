...
we only use normalized relative values representing the percentage of constraints and constraint violations belonging to the respective class. There is a strong overlap between \emph{RDFS/OWL Based} and \emph{Constraint Language Based} constraint types as in many cases constraint types are expressible by classical constraint languages and OWL. This is the reason why the percentage values of constraints and violations grouped by the classification according to the expressivity of constraint languages do not accumulate to 100\%. 
...
\begin{table}[H]
    ...
    %\\ \midrule
		 & 35 & 5,540,988 & 213 & 54,751,851 \\
		\hline
		\textbf{\emph{SPARQL}} & \textbf{80.0\%} & \textbf{100.0\%} & 59.7\% & 78.2\% \\
